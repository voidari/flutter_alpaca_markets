...
/// The class used for retrieving portfolio history related content.
class PortfolioHistoryManager {
  ...
  static Future<PortfolioHistory?> getPortfolioHistory(
    ...
    http.Response response =
        await requestBuilder.get("v2/account/portfolio/history");
    if (HttpStatus.ok != response.statusCode) {
      return null;
    }
    dynamic json = jsonDecode(response.body);
    return PortfolioHistory.fromMap(json);
  }
}
